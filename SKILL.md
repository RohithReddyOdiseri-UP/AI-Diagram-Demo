...
- **Use a template** when the diagram type matches one in `assets/templates/` or `assets/up-templates/`. Copy the template structure and replace placeholder values.
