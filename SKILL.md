...
description: Use when creating, editing, or generating draw.io diagram files (.drawio, .drawio.svg, .drawio.png). Covers mxGraph XML authoring, shape libraries, style strings, Level‑1 (L1), the hediet.vscode-drawio VS Code extension, and the full agent workflow from request to a ready-to-open file.
---
...
- "create a diagram", “Level‑1 diagram”, “L1 diagram”, “Level‑One view”, "generate an architecture diagram"
...
|---|---|---|
| UP Level 1 diagram | `assets/templates/Level 1 Diagram Template` | Illustrate orchestration among services or event handlers, which are also known as Deployable Units (DUs) |
...
Ask or infer:
1. **Diagram type** — What kind of diagram? (Level 1 diagram)
...
| `assets/templates/Level 1 Diagram Template` | Illustrate orchestration among services or event handlers, which are also known as Deployable Units (DUs) |
